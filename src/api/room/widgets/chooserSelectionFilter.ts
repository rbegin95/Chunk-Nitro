...
void main(void) {
    ...
    if(currentColor.r == 0.0 && currentColor.g == 0.0 && currentColor.b == 0.0 && currentColor.a > 0.0) {
        ...
        gl_FragColor = vec4(colorOverlay.r, colorOverlay.g, colorOverlay.b, currentColor.a * 0.35);
    }
}`;
...
export class ChooserSelectionFilter extends NitroFilter
{
    ...
    constructor(lineColor: number | number[] = [0.6, 0.85, 1], color: number | number[] = [0.4, 0.7, 1])
    {
